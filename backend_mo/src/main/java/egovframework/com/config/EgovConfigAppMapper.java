...
@MapperScan(value="com.system.backoffice.**.mapper, egovframework.**.mapper",sqlSessionFactoryRef="sqlSession")
public class EgovConfigAppMapper {
	...
	private String mapperConfigerLocation = "classpath:/egovframework/mapper/config/mysql-config.xml";
