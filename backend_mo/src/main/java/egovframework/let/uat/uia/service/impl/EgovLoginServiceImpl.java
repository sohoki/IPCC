...
import com.system.backoffice.uat.uia.mapper.UserTokenMapper;
import com.system.backoffice.uat.uia.models.UserToken;
...
public class EgovLoginServiceImpl extends EgovAbstractServiceImpl implements EgovLoginService {
	 ...
	 */
	@Override
	public String searchId(AdminLoginVO vo) throws Exception {
	...
	@Transactional
	@Override
	public boolean searchPassword(AdminLoginVO vo) throws Exception {
