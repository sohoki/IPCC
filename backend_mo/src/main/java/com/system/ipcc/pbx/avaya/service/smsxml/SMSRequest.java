...
public class SMSRequest
{
    ...
    private void submitRequest()
    {
        ...
        System.out.println( login + " is submitting request: [ operation:" + operation + "modelName:" + modelName
        ...
        catch (WebServiceException re)
        {
            ...
            System.out.println("A SOAP fault was raised: " + re);
            faultRaised = true;
            faultString = "" + re;
        }
        ...
        if ( ! faultRaised )
        {
            ...
            else
            {
                ...
                System.out.println( "The request returned an error (result_code == 1)" );
                System.out.println( "Reason: " + result.getMessageText() );
     ...
     */
     private void manageSession()
     {
        ...
        if ( ! faultRaised )
        {
            ...
            {
                System.out.println(" Could not properly manage session ID in SOAP header" + e);
            }
        }
    }
